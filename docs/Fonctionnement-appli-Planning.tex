...
\begin{itemize}
  ...
  \textbf{référents} d'une semaine existante (les bénévoles ne sont pas recopiés). Pratique
  quand les trajets se répètent d'une semaine à l'autre.
...
\eyebrow{Semainier : heures verticales, jours en colonnes}

La semaine s'affiche en \textbf{grille horaire} : colonnes = jours, lignes = heures. Chaque
créneau est un \textbf{bloc coloré} placé selon ses horaires ; deux créneaux du même jour qui
se chevauchent se mettent \textbf{côte à côte} ; un créneau dont l'horaire n'est pas
interprétable va dans la bande \textbf{« heure ? »} en haut de la colonne. Le bouton
\textbf{+ Créneau} est en \textbf{haut} de chaque colonne. Le bloc affiche intitulé, horaires,
référents, bénévoles et notes (tout le détail dans l'infobulle au survol) ; \textbf{cliquer un
bloc ouvre son éditeur}. Le bouton \textbf{« Colonnes - / + »} élargit ou resserre les
colonnes. Une \textbf{semaine archivée} passe en lecture seule (ni + Créneau, ni édition des
blocs) : cliquez \textbf{« Réactiver »} pour la modifier de nouveau.
...
\begin{itemize}
  \item consulter toute la semaine — en \textbf{vue liste} (jour par jour, choisie par défaut
  sur téléphone) ou en \textbf{vue grille}, via la bascule en haut ;
...
(\texttt{planning\_public}, \texttt{inscrire\_benevole}, \texttt{desinscrire\_benevole}) qui
prennent le code du lien en paramètre.
